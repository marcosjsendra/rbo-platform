      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-center space-x-8">
            ...
            <Link
              href="/about-us"
              className="group relative text-sm font-medium uppercase tracking-wide text-gray-700 transition-colors duration-300 hover:text-blue-600"
            >
              <span>About</span>
          ...
          >
            <div className="px-4 pt-4 pb-6 space-y-3">
              ...
              >
                <Link
                  href="/about-us"
                  className="block px-3 py-2.5 text-sm font-medium uppercase tracking-wide text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200"
                >
                  About
                </Link>
              </motion.div>
